...
def create_database_nutrition() -> None:
    ...
    drop_table(conn, files['delete'])
    create_tables(conn, files['create'])
...
def create_database_plan() -> None:
    ...
    files = {
        'delete': './sql_scripts/plan/delete_tables_user.sql',
        'create': './sql_scripts/plan/create_tables_user.sql'
    }
