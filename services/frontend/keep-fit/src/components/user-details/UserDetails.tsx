...
import GenderModel from "../../types/models/GenderModel";
import ActivityTypeModel from "../../types/models/ActivityTypeModel";
import DietTypeModel from "../../types/models/DietTypeModel";
import UserDetailsModel from "../../types/models/UserDetailsModel";
...
class UserDetails extends React.Component<any, any>{
    ...
    async sendUserDetailsUpdate(){
        try {
            if (!_.isEqual(this.state.userDetails, this.state.userDetailsAux)) {
                                                ...
                                                >
                                                    ...
                                                    <Grid item className={"grid-input"} xs={6}>
                                                        <TextField
                                                            ...
                                                            className={"text-field"}
                                                            disabled={true}
                                                            defaultValue={this.state.userDetails.idealWeight}
                                                        />
                                                    </Grid>
                                                    <Grid item className={"grid-input"} xs={6}>
                                                        <TextField
                                                            ...
                                                            className={"text-field"}
                                                            disabled={true}
                                                            defaultValue={this.state.userDetails.calories}
                                                        />
                                                    </Grid>
                                                    <Grid item className={"grid-input"} xs={6}>
                                                        <TextField
                                                            ...
                                                            className={"text-field"}
                                                            disabled={true}
                                                            defaultValue={this.state.userDetails.bmi}
                                                        />
                                                    </Grid>
                                                    <Grid item className={"grid-input"} xs={6}>
                                                        <TextField
                                                            ...
                                                            className={"text-field"}
                                                            disabled={true}
                                                            defaultValue={this.state.userDetails.wnd}
                                                        />
                                                    </Grid>
                                                    <Grid item className={"grid-input"} xs={6}>
                                                        <FormControl
